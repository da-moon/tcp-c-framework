/// @source      Time.c
/// @description Implementation of the Time facility.
...
TS2API void time_formatCurrentDate(char * formattedDate)
{
...
TS2API void time_formatCurrentShortDatePacked(char * formattedDate)
{
...
TS2API void time_formatCurrentShortDateReversePacked(char * formattedDate)
{
...
TS2API void time_formatCurrentTime(char * formattedTime)
{
...
TS2API void time_formatCurrentTimePacked(char * formattedTime)
{
...
TS2API void time_formatDate(char * formattedDate, time_t timestamp)
{
   struct tm result;
...
TS2API void time_formatShortDatePacked(char * formattedDate, time_t timestamp)
{
   struct tm result;
...
TS2API void time_formatShortDateReversePacked(char * formattedDate, time_t timestamp)
{
   struct tm result;
...
TS2API void time_formatTime(char * formattedTime, time_t timestamp)
{
   struct tm result;
...
TS2API void time_formatTimePacked(char * formattedTime, time_t timestamp)
{
   struct tm result;
