...
// control variables
bool beginShift;    // begins shift or closes terminal ?
bool sendOperation; // sends operation or ends shift ?

// prototypes
bool checkConnection();
bool checkReplyHeader(Message*, cchar*e, ushort);
void createMessage(Message*);
void createMessageHeader(Message*, cchar*);
void createMsg_0000(Message*);
void createMsg_0010(Message*);
void createMsg_0020(Message*);
void createMsg_0030(Message*);
void createMsg_0040(Message*);
void createMsg_0050(Message*);
cchar* format(cchar*, va_list);
void processReply(Message*);
void processReply_0000(Message*);
void processReply_0010(Message*);
void processReply_0020(Message*);
void processReply_0030(Message*);
void processReply_0040(Message*);
void processReply_0050(Message*);
uint recvReply(Message*);
bool sendMessage(Message*);
void synchronizeWithServer(Message*);
void waitNextState();
...
int main()
{
   ...
   waitNextState(); // randomizes first transaction
...
bool checkReplyHeader(Message* msg, cchar* tranCode, ushort replySize)
{
...
void createMessageHeader(Message* msg, cchar* tranCode)
{
...
void createMsg_0000(Message* msg)
{
...
void createMsg_0010(Message* msg)
{
...
void createMsg_0020(Message* msg)
{
...
void createMsg_0030(Message* msg)
{
   char buf[20];
...
void createMsg_0040(Message* msg)
{
...
void createMsg_0050(Message* msg)
{
...
void processReply_0000(Message* msg)
{
...
void processReply_0010(Message* msg)
{
...
void processReply_0020(Message* msg)
{
...
void processReply_0030(Message* msg)
{
...
void processReply_0040(Message* msg)
{
...
void processReply_0050(Message* msg)
{
...
void synchronizeWithServer(Message* msg)
{
   int secs;
