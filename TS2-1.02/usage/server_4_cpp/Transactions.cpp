...
const char sourceID[] = "TRA";

// transaction processing functions
Message* tranFunc_0000(const Message* in);
Message* tranFunc_0010(const Message* in);
Message* tranFunc_0020(const Message* in);
Message* tranFunc_0030(const Message* in);
Message* tranFunc_0040(const Message* in);
Message* tranFunc_0050(const Message* in);
...
// helper functions
bool checkTerminalConnectionID(short, uint, ushort);
Message* getReplyMessageTo(const Message*, cchar*, ushort);
short getTerminalIndex(cchar*);
void setErrCode(Message*, ushort);
void setTranCode(Message*, cchar*);
...
Message* tranFunc_0000(const Message* msgIn)
{
   short termIndex;
...
Message* tranFunc_0010(const Message* msgIn)
{
   short termIndex;
   Message* msgOut = NULL;
...
Message* tranFunc_0020(const Message* msgIn)
{
   short termIndex;
   Message* msgOut = NULL;
...
Message* tranFunc_0030(const Message* msgIn)
{
   short termIndex;
   OpFunc* opFunc;
   Message* msgOut = NULL;
...
Message* tranFunc_0040(const Message* msgIn)
{
   short termIndex;
   Message* msgOut = NULL;
...
Message* tranFunc_0050(const Message* msgIn)
{
   short termIndex;
   Message* msgOut = NULL;
...
bool checkTerminalConnectionID(short termIndex, uint ipAddr,
...
Message* getReplyMessageTo(const Message* msgIn, cchar* tranCode,
   ushort replyLen)
{
...
short getTerminalIndex(cchar* terminalID)
{
...
void setErrCode(Message* msg, ushort errCode)
{
...
void setTranCode(Message* msg, cchar* code)
{
   char* buf = server_messageBuffer(msg);
   ReplyHeader* rh = (ReplyHeader*)buf;
