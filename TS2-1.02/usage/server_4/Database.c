...
static Terminal terminals[N_MAX_TERMS];

// helper functions
static void operatorTable_init(void);
static void serialNumberTable_init(void);
static void supervisorTable_init(void);
static void terminalId_init(void);

static bool checkEmployee(void*, void*);
static bool checkSerialNumber(void*, void*);
static bool checkTerminalID(void*, void*);

static void loadTable(cchar*, ushort, List*);
...
static bool checkEmployee(void* entry, void* arg)
{
...
static bool checkSerialNumber(void* entry, void* arg)
{
...
static bool checkTerminalID(void* entry, void* arg)
{
...
static void loadTable(cchar* fileName, ushort fieldLen, List* list)
{
   char buf[80];
   char field[80];
   int n, nRecords = 0;
