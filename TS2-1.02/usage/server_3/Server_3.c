...
static const char sourceID[] = "AAA";
...
static threadfunc threadFunc1(void*);
static threadfunc threadFunc2(void*);
...
int main(int argc, char* argv[])
{
   ...
   server_addThreads(nThreads1, threadFunc1, "thread type 1");

   server_logInfo("adding %d threads os type 2", nThreads2);
   server_addThreads(nThreads2, threadFunc2, "thread type 2");
   // etc
